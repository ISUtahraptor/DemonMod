...
package net.mcreator.demonmod.world.dimension;
...
import net.mcreator.demonmod.procedures.TheBruhMachinePlayerEntersDimensionProcedure;
...
public class TheBruhMachineDimension extends DemonmodModElements.ModElement {
	@ObjectHolder("demonmod:demondimision")
	public static final ModDimension dimension = null;
	@ObjectHolder("demonmod:demondimision_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public TheBruhMachineDimension(DemonmodModElements instance) {
		super(instance, 1);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("demondimision"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("demonmod:demondimision")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("demonmod:demondimision"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("demonmod:demondimision"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("demonmod:demonbiome")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new TheBruhMachineItem().setRegistryName("demondimision"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			super(Block.Properties.create(Material.PORTAL).doesNotBlockMovement().tickRandomly().hardnessAndResistance(-1.0F).sound(SoundType.GLASS)
					.lightValue(6).noDrops());
			setRegistryName("demondimision_portal");
		}
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			...
			if (random.nextInt(110) == 0)
				world.playSound(pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5,
						(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation(("demonmod:demonhurt"))),
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = TheBruhMachineDimension.CustomPortalBlock.createPatternHelper(entity.world, new BlockPos(pos));
	...
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "demondimision_portal",
	...
	public static class TeleporterDimensionMod extends Teleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = TheBruhMachineDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
		...
		if (event.getTo() == type) {
			{
				...
				TheBruhMachinePlayerEntersDimensionProcedure.executeProcedure($_dependencies);
			}
		}
	}
