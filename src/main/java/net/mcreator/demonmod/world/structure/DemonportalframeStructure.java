...
package net.mcreator.demonmod.world.structure;
...
public class DemonportalframeStructure extends DemonmodModElements.ModElement {
	public DemonportalframeStructure(DemonmodModElements instance) {
		super(instance, 3);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("demonmod", "demonportal"));
						if (template == null)
							return false;
