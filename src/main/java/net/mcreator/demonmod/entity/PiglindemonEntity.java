...
public class PiglindemonEntity extends DemonmodModElements.ModElement {
	public static EntityType entity = null;
	public PiglindemonEntity(DemonmodModElements instance) {
		super(instance, 35);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.7999999999999999f, 1.8f))
						.build("piglindemon").setRegistryName("piglindemon");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("piglindemon"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelpiglin(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("demonmod:textures/demon_2.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("demonmod:demonliving1"));
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("demonmod:demonhurt"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("demonmod:whywhywhy"));
		}
	...
	public static class Modelpiglin extends EntityModel<Entity> {
		...
		public Modelpiglin() {
			...
			setRotationAngle(Head, -0.0349F, 0.0873F, 0.0F);
			...
			LeftEar.setTextureOffset(57, 38).addBox(0.0F, 0.0F, -2.0F, 1.0F, 5.0F, 4.0F, 0.0F, false);
			RightEar = new ModelRenderer(this);
			RightEar.setRotationPoint(-4.5F, -6.0F, 0.0F);
			Head.addChild(RightEar);
			setRotationAngle(RightEar, 0.0F, 0.0F, 0.4363F);
			RightEar.setTextureOffset(57, 22).addBox(-1.0F, 0.0F, -2.0F, 1.0F, 5.0F, 4.0F, 0.0F, false);
